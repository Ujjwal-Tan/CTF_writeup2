# CTF_writeup2
Challenge - Northstar Records <br>
CTF Name: [EHAX RecCTF 2026] <br>
...
The exact step-by-step methodology I used to solve this :<br>
Inspect the Cookies-<br>
  i.Open Chrome DevTools (F12 or Ctrl+Shift+I) on the challenge page.<br>
  ii.Go to the Application tab > Storage > Cookies .<br>
  iii.Look for cookie named session,auth,role,user or token.<br>
